...
DROP DATABASE IF EXISTS SQLScriptDealership;
CREATE DATABASE SQLScriptDealership;

USE SQLScriptDealership;
...
INSERT INTO vehicles (vin, make, model, color, year, miles, price, sold,type) 
VALUES ('1HGCM82633A123456', 'Honda', 'Accord', 'Silver', 2010, 80000, 9000.00, 0, 'Sedan'),
	   ('5XYZU3LB7DG025874', 'Hyundai', 'Santa Fe', 'Blue', 2015, 60000, 13000.00, 0, 'Suv'),
	   ('3GNAL4EK4DS567890', 'Chevrolet', 'Equinox', 'Black', 2013, 70000, 11000.00, 0, 'Suv'),
	   ('WAUFFAFL3BN123456', 'Audi', 'A4', 'White', 2011, 85000, 9500.00, 0, 'Sedan'),
	   ('KM8JT3AB2DU123456', 'Kia', 'Sportage', 'Red', 2014, 55000, 12000.00, 0, 'Suv'),
	   ('1HGCM82634A123457', 'Honda', 'Civic', 'Black', 2012, 75000, 8000.00, 0, 'Sedan'),
	   ('5XYZU3LB8DG025875', 'Hyundai', 'Elantra', 'Silver', 2016, 40000, 14000.00, 0,'Sedan'),
	   ('3GNAL4EK5DS567891', 'Chevrolet', 'Malibu', 'Blue', 2014, 60000, 10000.00, 0, 'Sedan'),
	   ('WAUFFAFL4BN123457', 'Audi', 'Q5', 'Gray', 2015, 70000, 16000.00, 0, 'Suv'),
	   ('KM8JT3AB3DU123457', 'Kia', 'Sorento', 'White', 2017, 35000, 18000.00, 0, 'Suv'),
	   ('1HGCM82635A123458', 'Honda', 'Accord', 'Silver', 2011, 90000, 8500.00, 0, 'Sedan'),
	   ('5XYZU3LB9DG025876', 'Hyundai', 'Tucson', 'Red', 2013, 55000, 12000.00, 0, 'Suv'),
	   ('3GNAL4EK6DS567892', 'Chevrolet', 'Cruze', 'Black', 2012, 80000, 9500.00, 0, 'Sedan'),
	   ('WAUFFAFL5BN123458', 'Audi', 'A6', 'White', 2014, 65000, 13000.00, 0, 'Suv'),
	   ('KM8JT3AB4DU123458', 'Kia', 'Optima', 'Blue', 2016, 45000, 15000.00, 0, 'Sedan'),
	   ('1HGCM82636A123459', 'Honda', 'Civic', 'Gray', 2013, 70000, 8500.00, 0, 'Sedan'),
	   ('5XYZU3LBAFG025877', 'Hyundai', 'Sonata', 'Silver', 2017, 40000, 14000.00, 0, 'Sedan'),
	   ('3GNAL4EK7DS567893', 'Chevrolet', 'Impala', 'Red', 2015, 60000, 11000.00, 0, 'Sedan'),
	   ('WAUFFAFL6BN123459', 'Audi', 'Q7', 'Black', 2016, 70000, 16000.00, 0, 'Suv'),
	   ('KM8JT3AB5DU123459', 'Kia', 'Forte', 'White', 2018, 35000, 18000.00, 0, 'Suv'),
	   ('1HGCM82637A123460', 'Honda', 'Accord', 'Silver', 2012, 80000, 9000.00, 0, 'Sedan'),
	   ('5XYZU3LBBFG025878', 'Hyundai', 'Elantra', 'Blue', 2016, 40000, 13000.00, 0, 'Sedan'),
	   ('3GNAL4EK8DS567894', 'Chevrolet', 'Malibu', 'Black', 2014, 60000, 10000.00, 0, 'Sedan'),
	   ('WAUFFAFL7BN123460', 'Audi', 'A4', 'Gray', 2015, 70000, 15000.00, 0, 'Sedan'),
	   ('KM8JT3AB6DU123460', 'Kia', 'Sportage', 'Red', 2017, 35000, 17000.00, 0, 'Sedan');
